...
const DOCS = {
    ...
    terms: {
        apiSections: '/api/policy/legal/terms/sections',
        apiSection:  '/api/policy/legal/terms/section',
        urlBase:     '/legal/terms',
        label:       'Terms of Service',
        navPage:     '',
        sidebarTitle:'Terms of Service',
        contentEl:   'terms-content',
        breadcrumbEl:'terms-breadcrumb',
        navFooterEl: 'terms-nav-footer',
    },
    privacy: {
        apiSections: '/api/policy/legal/privacy/sections',
        apiSection:  '/api/policy/legal/privacy/section',
        urlBase:     '/legal/privacy',
        label:       'Privacy Policy',
        navPage:     '',
        sidebarTitle:'Privacy Policy',
        contentEl:   'privacy-content',
        breadcrumbEl:'privacy-breadcrumb',
        navFooterEl: 'privacy-nav-footer',
    },
};
